...
with st.sidebar:
    ...
    current_index = nav_options.index(st.session_state["active_nav"]) if st.session_state["active_nav"] in nav_options else 0
...
def render_home_page():
    ...
    st.markdown("""
        <div class="hero-container">
            ...
            <p style="color: #374151; font-size: 1.05rem; line-height: 1.6; margin-bottom: 0;">
                AI-driven voice assistant for livelihood mapping and NSQF-aligned skilling recommendations for Scheduled Caste (SC) communities under the Grant-in-Aid (GIA) component of PM-AJAY.
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    with start_col2:
        start_button = st.button(
            "🚀 Start My Journey / अपनी कौशल यात्रा शुरू करें",
            type="primary",
    ...
    with col3:
        st.markdown("""
            <div class="info-card">
                ...
                <p>
                    Connects beneficiaries with certified training centers, district-level livelihood clusters, and micro-enterprise grant opportunities under the PM-AJAY GIA scheme.
                </p>
            </div>
        """, unsafe_allow_html=True)
    ...
    with step_col4:
        st.success("💼 **4. 'My Skill Journey'**\n\nStep-by-step pathway to training, certification, and livelihood grants.")
